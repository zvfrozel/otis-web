...
class TestLevelSystem(EvanTestCase):
    ...
    def test_multi_student_annotate(self):
        ...
        self.assertEqual(getattr(alice, "num_semesters"), 1)
        ...
        self.assertEqual(getattr(bob, "num_semesters"), 1)
        ...
        self.assertEqual(getattr(carol, "num_semesters"), 1)
        ...
        self.assertEqual(getattr(donald, "num_semesters"), 1)
